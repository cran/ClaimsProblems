...
#' @description This function returns the graphical representation of the path of awards of a rule for a claims vector and a pair of claimants.
#' @param d The vector of claims.
#' @param claimants The two claimants.
