...
#' @param Rules The two rules: AA, APRO, CE, CEA, CEL, AV, DT, MO, PIN, PRO, RA, Talmud, RTalmud.
#' @param Info A logical value.
#' @return If \code{Info = FALSE}, the Lorenz-dominance relation between the awards vectors selected by both rules.
...
#'
#' @seealso \link{cumawardscurve}, \link{deviationindex}, \link{giniindex}, \link{indexgpath}, \link{lorenzcurve}.
#' @examples
#' E=10
#' d=c(2,4,7,8)
#' Rules=c(AA,CEA)
