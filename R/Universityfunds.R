#' University funds data
#'
#' @name Universityfunds
#' @docType data
#' @description
...
#' @references Pulido, M., Sánchez Soriano, J., and Llorca, N. (2002). Game Theory Techniques for University Management: An Extended Bankruptcy Model.
...
#' @source The data were obtained from Pulido et al (2002).
#' @examples
